...
const CryptoDetails = () => {
  ...
  const stats = [
    { title: 'Price to USD', value: `$ ${cryptoDetails.price && millify(cryptoDetails.price, { precision: 5 })}`, icon: <DollarCircleOutlined /> },
  ...
  return (
    <Col className='coin-detail-container'>
      ...
      <LineChart coinHistory={coinHistory} currentPrice={Number(cryptoDetails.price).toFixed(5)} coinName={cryptoDetails.name} />
